...
<body>
  ...
  <form action="add_to_cart.php" method="POST">
    ...
    <button type="submit" class="btn-add-cart">Add to Cart</button>
    <button type="submit" formaction="buy.php" class="btn-buy-now">Buy Now</button>
...
<!-- Product Card 4 -->
<?php 
if ($category == 'all' || $category == 'moisturizer') { 
    include 'navbar.php'; 
    if ($cartMessage !== ''): ?>
        <div id="cartPopup" class="cart-popup">
            <div class="cart-popup-box">
                <h4>Item Added</h4>
                <p>Your item was successfully added to the cart.</p>
            </div>
        </div>
    <?php endif; ?>
<?php } ?>
...
<script>
  function toggleDesc(link) {
   ...
   // toast behavior for cart message
